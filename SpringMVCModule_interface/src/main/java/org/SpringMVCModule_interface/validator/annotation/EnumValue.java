...
public @interface EnumValue {
	...
	class Validator implements ConstraintValidator<EnumValue, Object> {
		...
		private Class<? extends Enum<?>> enumClass;		//枚举类
		
		private String enumMethod;	//枚举验证方法

		@Override
		public void initialize(EnumValue EnumValidate) {
			enumMethod = EnumValidate.enumMethod();
